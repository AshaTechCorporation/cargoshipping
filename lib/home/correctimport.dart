              ...
              Padding(
                ...
                child: RichText(
                  text: TextSpan(
                    ...
                    children: [
                      TextSpan(
                        text: 'บริการออกเอกสารนำเข้า ใบขนส่ง ใบเสร็จศุลกากร ใบกำกับภาษี เอกสารที่เกี่ยวข้อง ทุกชนิด ในนามลูกค้า ทั้งในนามบุคคลธรรมดา และนิติบุคคล ',
                      ),
                      TextSpan(
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'ใบตราส่งสินค้า Bill Of Landing (B/L)',
                            style: TextStyle(color: Colors.black, fontSize: 13, fontWeight: FontWeight.bold),
                          ),
                        ],
                      ),
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'ใบอนุญาต หรือ หนังสืออนุญาตสำหรับสินค้าควบคุมการนำเข้า (License)',
                            style: TextStyle(color: Colors.black, fontSize: 13, fontWeight: FontWeight.bold),
                          ),
                        ],
                      ),
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'ใบรับรองแหล่งกำเนิดสินค้า (Certificate of Origin / Form E) กรณีขอลดหรือยกเว้นอัตรากากรขาเข้า',
                            style: TextStyle(color: Colors.black, fontSize: 13, fontWeight: FontWeight.bold),
                          ),
                        ],
                      ),
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'เอกสารอื่น ๆ เช่น เอกสารแสดงส่วนผสม คุณลักษณะการใช้งานของสินค้า เป็นต้น',
                            style: TextStyle(color: Colors.black, fontSize: 13, fontWeight: FontWeight.bold),
                          ),
                        ],
                      ),
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'กรณี นิติบุคคล สำเนาหนังสือจดทะเบียนบริษัท เซ็นลงนามผู้มีอำนาจและประทับตรา',
                            style: TextStyle(color: Colors.black, fontSize: 13, fontWeight: FontWeight.bold),
                          ),
                        ],
                      ),
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'ใบลงทะเบียน paperless กับกรมศุลกากร',
                            style: TextStyle(color: Colors.black, fontSize: 13, fontWeight: FontWeight.bold),
                          ),
                        ],
                      ),
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'หนังสือมอบอำนาจส่งข้อมูลใบขนสินค้าทางอิเล็กทรอนิกส์',
                            style: TextStyle(color: Colors.black, fontSize: 13, fontWeight: FontWeight.bold),
                          ),
                        ],
                      ),
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'ใบเสร็จค่าภาษีอากรขาเข้าและภาษีมูลค่าเพิ่ม',
                            style: TextStyle(color: Colors.black, fontSize: 13, fontWeight: FontWeight.bold),
                          ),
                        ],
                      ),
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'ใบกำกับภาษีค่าบริการขนส่งสินค้า',
                            style: TextStyle(color: Colors.black, fontSize: 13, fontWeight: FontWeight.bold),
                          ),
                        ],
                      ),
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'ค่าดำเนินการพิธีการทางศุลกากร จีน – ไทย',
                            style: TextStyle(color: Colors.black, fontSize: 13, fontWeight: FontWeight.bold),
                          ),
                        ],
                      ),
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'ค่าภาษีอากรขาเข้า ภาษีอื่น ๆ ภาษีมูลค่าเพิ่ม (ตามจริง)',
                            style: TextStyle(color: Colors.black, fontSize: 13, fontWeight: FontWeight.bold),
                          ),
                        ],
                      ),
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'ค่าบริการ เอกสารขอคืนภาษีฝั่งจีน (TAX refund) ขนส่งทางรถ , ขนส่งทางเรือ',
                            style: TextStyle(color: Colors.black, fontSize: 13, fontWeight: FontWeight.bold),
                          ),
                        ],
                      ),
