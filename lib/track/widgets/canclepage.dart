      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Center(
              child: Text(
                'คำสั่งซื้อนี้ถูกยกเลิกเนื่องจากไม่ได้รับการยืนยันคำสั่งซื้อในระยะเวลาชำระ',
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      padding:
                          EdgeInsets.symmetric(horizontal: size.width * 0.077),
                      child: Row(
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          '(฿ 2,000)',
                          style: TextStyle(
                              color: headingtext, fontWeight: FontWeight.bold),
                        )
                      ],
                    ),
                    SizedBox(
                ...
                child: Column(
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text('ค่าสินค้าทั้งหมด',style: TextStyle(
                          fontSize: 13,color: headingtext,fontWeight: FontWeight.bold
                        ),),
                        Text('฿ 2,345.53',style: TextStyle(
                          fontSize: 13,color: headingtext,fontWeight: FontWeight.bold
                        ),)
                      ],
                    ),
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text('ค่าขนส่งภายในจีน',style: TextStyle(
                          fontSize: 13,color: headingtext,fontWeight: FontWeight.bold
                        ),),
            ...
            Container(
              ...
              color: Color(0xfff3e0e1),
              child: Padding(
                padding:EdgeInsets.symmetric(horizontal: size.width * 0.03),
                child: Row(
                  children: [
                    Text('ยอดเงินชำระทั้งหมด',style: TextStyle(
                      fontSize: 13, color: Colors.black,fontWeight: FontWeight.bold
                    ),),
                    Spacer(),
                    Text('(ยังไม่รวมค่าบริการเสริม)',style: TextStyle(
                      fontSize: 13,color: headingtext,fontWeight: FontWeight.bold
                    ),),
                    SizedBox(
                      width: size.width * 0.025,
                    ),
                    Text('฿ 4,345.00',style: TextStyle(
                      fontSize: 16,color: red1,fontWeight: FontWeight.bold
                    ),)
                  ],
                ),
              ),
