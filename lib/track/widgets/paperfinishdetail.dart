...
class Paperfinishdetail extends StatefulWidget {
  const Paperfinishdetail({super.key});

  @override
  State<Paperfinishdetail> createState() => _PaperfinishdetailState();
}

class _PaperfinishdetailState extends State<Paperfinishdetail> {
  bool isChecked = true;
  @override
